...
![One QED amplitude, two views: the Compton process with its substrate amplitude color-mapped term-by-term (left), and the K_7-on-torus / Cl(0,7) substrate its gamma-matrices descend from (right)](assets/readme_hero.png)
